...
- Support for multiple cameras. The preset "Salle" will be recalled when presenter location is set to "remote"
- Added "autoStartPresentationConnector:2" in RoomConfig (usbmode)
