...
export var config = {
  ...
  room: {
    name: 'DKN2161',                        //Nom du système, doit être unique
    ...
    controlSystemSerial: '2123JBH00022',     //numéro de série du processeur crestron
  ...
  zoom: {
    askHostKeyWithOBTP: false,                 //Demande le host key dans une boite de dialogue lorsque l'appel est effectué via le OBTP
