...
export var config = {
  ...
  room: {
    ...
    controlSystemSerial: '2120JBH05201',     //numéro de série du processeur crestron
  ...
  lights: {                                    //Configuration de l'éclairage
    zones: [
      {
        name: 'Console',                         //Nom affiché dans l'interface graphique
