...
export var config = {
  ...
  room: {
    name: 'VND1245',                        //Nom du système, doit être unique
    supportContact: 'Courriel: aide@cifss.ulaval.ca',     //Email du soutien technique, '' si aucun
    ...
    controlSystemSerial: '2123JBH00027',     //numéro de série du processeur crestron
  ...
  usbmode: {
    ...
    autoStartPresentationConnector:2 //Automatically start the sharing of this input on usbmode activation
  },
  zoom: {
  ...
  lights: {                                    //Configuration de l'éclairage
    zones: [
      {
        name: 'Avant',                         //Nom affiché dans l'interface graphique
        id: 'lights_zone1',                    //ID interne envoyé au contrôleur de lumières
        ...
        steps: 11                              //Pourcentage d'incrémentation
